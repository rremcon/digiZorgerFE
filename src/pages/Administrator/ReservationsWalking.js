...
function ReservationsWalking() {
    ...
    useEffect(()=> {
        ...
        async function fetchOrders() {
            ...
            try {
                const response = await axios.get('http://localhost:8080/reservations/selecteditem/?selecteditem=WANDELEN ROOIPANNEN', {
        ...
        <>
            <main className="outer-content-container">
                <div className="inner-content-container">
                    ...
                    <h1 className="page-title">Inschrijvingen Wandelen Rooipannen</h1>
                    <br/>
                    <Button
...
export default ReservationsWalking;