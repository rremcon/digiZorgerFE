...
function ReservationsWeekendTrip() {
    ...
    useEffect(()=> {
        ...
        async function fetchOrders() {
            ...
            try {
                const response = await axios.get('http://localhost:8080/reservations/selecteditem/?selecteditem=WEEKEND WEG', {
        ...
        <>
            <main className="outer-content-container">
                <div className="inner-content-container">
                    ...
                    <h1 className="page-title">Inschrijvingen Weekend Weg</h1>
                    <br/>
                    <Button
...
export default ReservationsWeekendTrip;