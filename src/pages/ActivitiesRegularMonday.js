    ...
    useEffect(()=> {
        async function fetchActivities() {
            try {
                ...
                const response = await axios.get('http://localhost:8080/activities/category/day?category=StandaardBasis&day=Maandag');
        ...
        <>
            <main className="outer-content-container">
                <div className="inner-content-container">
                    ...
                    <h1 className="page-title">Standaard Activiteiten Maandag</h1>
