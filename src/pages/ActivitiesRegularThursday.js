...
function Activities() {
    ...
    useEffect(()=> {
        async function fetchActivities() {
            try {
                // const response = await axios.get('http://localhost:8080/activities/day?day=Donderdag');
                const response = await axios.get('http://localhost:8080/activities/category/day?category=StandaardBasis&day=Donderdag');
