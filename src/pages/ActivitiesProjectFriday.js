    ...
    useEffect(()=> {
        async function fetchActivities() {
            try {
                ...
                const response = await axios.get('http://localhost:8080/activities/category/day?category=ProjectBasis&day=Vrijdag');
        ...
        <>
            <main className="outer-content-container">
                <div className="inner-content-container">
                    ...
                    <h1 className="page-title">Projectmatige Activiteiten Vrijdag</h1>
