...
function Activities() {
    ...
    useEffect(()=> {
        async function fetchActivities() {
            try {
                // const response = await axios.get('http://localhost:8080/activities/day?day=Woensdag');
                const response = await axios.get('http://localhost:8080/activities/category/day?category=StandaardBasis&day=Woensdag');
        ...
        <>
            <main className="outer-content-container">
                <div className="inner-content-container">
                    ...
                    <h1 className="page-title">Standaard Activiteiten Woensdag</h1>
